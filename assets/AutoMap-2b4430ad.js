import{V as G,r as d,E as an,Q as rn,C as F,B as S,M as $,T as C,R as h,a as z,S as f,P as sn,b as _,c as Z,U as cn,O as V,D as k,d as ln,e as mn,f as vn,g as un,h as dn,i as U,j as E,L as pn,A as fn,k as gn,l as yn,m as Cn,n as hn,G as v,N as H,o as xn,p as W,q as Mn,s as Pn,t as q,u as wn,v as Sn,w as _n,x as bn,y as An,I as En,z as Rn,F as In,H as On,J as X,K as Dn}from"./index-96e2e7e8.js";const Nn=(n,t,i)=>{const e=t.map((a,r)=>a-n[r]);return Math.sqrt(e[0]**2+e[1]**2+e[2]**2)<i},J=(n,t=1)=>{const i=[0,0,0];let e=[0,0,0];for(;Nn(e,i,n);)e=Tn(t);return e},Tn=(n=1)=>{const t=Math.random(),i=Math.random(),e=t*2*Math.PI,o=Math.acos(2*i-1),a=Math.cbrt(Math.random()),r=Math.sin(e),s=Math.cos(e),m=Math.sin(o),u=Math.cos(o),c=a*m*s,l=a*m*r,p=a*u;return[c*n,l*n,p*n]};(function(){const n=new G,t=new an,i=new rn,e=new G;return function(o,a){const[r,s,m]=J(a.distanceStart,a.distanceEnd);n.x=r,n.y=s,n.z=m,t.x=Math.random()*2*Math.PI,t.y=Math.random()*2*Math.PI,t.z=Math.random()*2*Math.PI,i.setFromEuler(t),e.x=e.y=e.z=d(2,1e3),o.compose(n,i,e)}})();const R=new F("#fff"),I=.01,O=.5;function Ln(n){return[(n[0]+d(I,O))%1,(n[1]+d(I,O))%1,(n[2]+d(I,O))%1]}function Gn(n,t){const[i]=$n(t);return n.addComponent(S,S.getDefaults(t)).addComponent($,{mesh:i}).addComponent(C,C.getDefaults()).addComponent(h,h.getDefaults())}const D=3e3,Fn=67319e8;function $n(n){var u;const t=(u=n.draw)==null?void 0:u.genColor,i=new z,e=new Float32Array(D);let o;t&&(o=new Float32Array(D));const a=n.distanceToParent,r=a+Fn;for(let c=0;c<D;c+=3){const[l,p,g]=J(a*f.getInstance().state.DISTANCE_SCALE,r*f.getInstance().state.DISTANCE_SCALE);if(e[c]=l,e[c+1]=p,e[c+2]=g,o&&t){const[b,x,M]=Ln([R.r,R.g,R.b]);o[c]=b,o[c+1]=x,o[c+2]=M}}const s=new sn({color:"#ffffff",sizeAttenuation:!0,size:.1,transparent:!0,opacity:.3}),m=new _(e,3);return i.setAttribute("position",m),o&&t&&i.setAttribute("color",new _(o,3)),[new Z(i,s)]}const zn=`
uniform float size;
uniform float scale;
...
void main() {
  ...
  vvPosition = worldPosition.xyz;
    ...
    `,N=new F("#fff"),T=.01,L=.5;function Bn(n){return[(n[0]+d(T,L))%1,(n[1]+d(T,L))%1,(n[2]+d(T,L))%1]}function jn(n,t){var o;const[i,e]=Vn(t);return n.addComponent(cn,e).addComponent(V,V.getDefaults(t.orbitalPeriod,(o=t.draw)==null?void 0:o.orbInvert)).addComponent(S,S.getDefaults(t)).addComponent(k,k.getDefaults(t.distanceToParent,!1)).addComponent(ln,{radius:t.distanceToParent,drawRadius:t.distanceToParent*f.getInstance().state.DISTANCE_SCALE}).addComponent($,{mesh:i}).addComponent(C,C.getDefaults()).addComponent(h,h.getDefaults()).addComponent(mn).addComponent(vn).addComponent(un).addComponent(dn)}function Vn(n){var x,M,B;const e=Math.round(((x=n.draw)==null?void 0:x.count)/4),o=n.distanceToParent*f.getInstance().state.DISTANCE_SCALE,a=o,r=(M=n.draw)==null?void 0:M.height,s=-r,m=(B=n.draw)==null?void 0:B.genColor,u=new z,c=new Float32Array(e*4*3);let l;m&&(l=new Float32Array(e*4*3));for(let P=0;P<e;P++){const j=P/e*Math.PI*2;for(let A=0;A<4;A++){const w=Math.random()*.15-.075,Q=Math.random()*(r-s)+s,K=Math.cos(j)*(o+a/2+w+w*25*d(-1.25,1.25)),Y=Q,nn=Math.sin(j)*(o+a/2+w+w*25*d(-1.25,1.25)),y=(P*4+A)*3;if(l&&m){const[tn,en,on]=Bn([N.r,N.g,N.b]);l[y]=tn,l[y+1]=en,l[y+2]=on}c[y]=K,c[y+1]=Y,c[y+2]=nn}}const p={size:{value:1},scale:{value:20},color:{value:[1,1,1]},lightPos:{value:[0,0,0]},basePos:{value:[0,0,0]},maxRad:{value:o},minRad:{value:o}},g=new U({transparent:!0,uniforms:p,vertexShader:zn,fragmentShader:Un}),b=new _(c,3);return u.setAttribute("position",b),l&&m&&u.setAttribute("color",new _(l,3)),[new Z(u,g),p]}const kn=`uniform vec3 glowColor;
