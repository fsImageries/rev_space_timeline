import{V as G,r as d,E as ae,Q as re,C as F,B as w,M as z,T as y,R as C,a as $,S as p,P as se,b as _,c as Q,U as ce,O as j,D as W,d as le,e as me,f as ve,g as ue,h as de,i as U,j as E,L as ge,A as pe,k as fe,l as he,m as ye,n as Ce,G as v,N as k,o as xe,p as H,q as Me,s as Pe,t as q,u as Z,v as Se,w as we,x as _e,y as be,z as Ae,F as Ee,I as Re,H as Oe,J as Te,K as X,W as De}from"./index-66111c42.js";const Ie=(e,t,i)=>{const n=t.map((a,r)=>a-e[r]);return Math.sqrt(n[0]**2+n[1]**2+n[2]**2)<i},J=(e,t=1)=>{const i=[0,0,0];let n=[0,0,0];for(;Ie(n,i,e);)n=Ne(t);return n},Ne=(e=1)=>{const t=Math.random(),i=Math.random(),n=t*2*Math.PI,o=Math.acos(2*i-1),a=Math.cbrt(Math.random()),r=Math.sin(n),s=Math.cos(n),m=Math.sin(o),u=Math.cos(o),c=a*m*s,l=a*m*r,g=a*u;return[c*e,l*e,g*e]};(function(){const e=new G,t=new ae,i=new re,n=new G;return function(o,a){const[r,s,m]=J(a.distanceStart,a.distanceEnd);e.x=r,e.y=s,e.z=m,t.x=Math.random()*2*Math.PI,t.y=Math.random()*2*Math.PI,t.z=Math.random()*2*Math.PI,i.setFromEuler(t),n.x=n.y=n.z=d(2,1e3),o.compose(e,i,n)}})();const R=new F("#fff"),O=.01,T=.5;function Le(e){return[(e[0]+d(O,T))%1,(e[1]+d(O,T))%1,(e[2]+d(O,T))%1]}function Ge(e,t){const[i]=ze(t);return e.addComponent(w,w.getDefaults(t)).addComponent(z,{mesh:i}).addComponent(y,y.getDefaults()).addComponent(C,C.getDefaults())}const D=3e3,Fe=67319e8;function ze(e){var u;const t=(u=e.draw)==null?void 0:u.genColor,i=new $,n=new Float32Array(D);let o;t&&(o=new Float32Array(D));const a=e.distanceToParent,r=a+Fe;for(let c=0;c<D;c+=3){const[l,g,f]=J(a*p.getInstance().state.DISTANCE_SCALE,r*p.getInstance().state.DISTANCE_SCALE);if(n[c]=l,n[c+1]=g,n[c+2]=f,o&&t){const[b,x,M]=Le([R.r,R.g,R.b]);o[c]=b,o[c+1]=x,o[c+2]=M}}const s=new se({color:"#ffffff",sizeAttenuation:!0,size:.1,transparent:!0,opacity:.3}),m=new _(n,3);return i.setAttribute("position",m),o&&t&&i.setAttribute("color",new _(o,3)),[new Q(i,s)]}const $e=`
uniform float size;
uniform float scale;
