...
function initLines(world: World) {
    ...
    const linepairs = [
        ...
        "Epsilon Eridani", "Delta Pavonis",
        "Epsilon Eridani", "107 Piscium",
        "Epsilon Eridani", "61 Cygni",
        "p Eridani", "Delta Pavonis",
        "61 Cygni", "Sol",
        "Ross 248", "Sol"
    ]
    world.ecManager.createEntity()
